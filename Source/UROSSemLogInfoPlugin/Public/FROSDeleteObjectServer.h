...
public:
	...
	FROSDeleteObjectServer(const FString& InName, TMap<AActor*, FJsonSerializableKeyValueMap> ActorRef, FString KeytoDelete) : FROSBridgeSrvServer(InName, TEXT("std_srvs/Trigger")) 
	{ 
